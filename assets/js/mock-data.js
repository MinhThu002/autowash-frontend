...
const MOCK_DATA = {
  ...
  loyaltyTiers: [
    {
      ...
      bookingWindow: 7,
      discountPercent: 0,
      benefits: ["Đặt lịch trước 7 ngày", "Tích điểm cơ bản"],
    },
    {
      id: "silver",
      name: "Silver",
      ...
      bookingWindow: 10,
      discountPercent: 5,
      benefits: ["Giảm 5%", "Đặt lịch 10 ngày", "Ưu tiên xếp hàng nhẹ"],
    },
    {
      id: "gold",
      name: "Gold",
      ...
      bookingWindow: 12,
      discountPercent: 10,
      benefits: ["Giảm 10%", "Đặt lịch 12 ngày", "Quà sinh nhật"],
    },
    {
      id: "platinum",
      name: "Platinum",
  ...
  bookings: [
    {
      id: "BK-2026-001",
      customerId: "cust-001",
      customerName: "Minh Thư 1",
      vehicleId: "veh-001",
      vehiclePlate: "51A-12345",
      serviceId: "svc-004",
      serviceName: "Rửa tiêu chuẩn",
      date: "2026-05-22",
      time: "09:00",
      status: "confirmed",
      totalPrice: 162000,
    ...
    },
    {
      id: "BK-2026-003",
      customerId: "cust-002",
      customerName: "Minh Thư 2",
      vehicleId: "veh-003",
      vehiclePlate: "30F-98765",
      serviceId: "svc-003",
      serviceName: "Rửa nhanh",
      date: "2026-05-20",
      time: "10:00",
      status: "pending",
      totalPrice: 114000,
    ...
    },
    {
      id: "BK-2026-004",
      customerId: "cust-003",
      customerName: "Minh Thư 3",
      vehicleId: "veh-001",
      vehiclePlate: "51A-99999",
      serviceId: "svc-005",
      serviceName: "Rửa cao cấp",
      date: "2026-05-19",
      time: "08:00",
      status: "in_progress",
      totalPrice: 297500,
    ...
    },
    {
      id: "BK-2026-006",
      customerId: "cust-004",
      customerName: "Minh Thư 4",
      vehicleId: "veh-003",
      vehiclePlate: "30F-11111",
      serviceId: "svc-004",
      serviceName: "Rửa tiêu chuẩn",
      date: "2026-05-18",
      time: "15:00",
  ...
  promotions: [
    {
      id: "promo-001",
      name: "Chào hè 2026",
      description: "Giảm giá mùa hè cho tất cả dịch vụ ô tô",
    ...
    },
    {
      ...
      description: "Giảm thêm cho hạng Gold trở lên",
      discountType: "percent",
      discountValue: 10,
    ...
    {
      id: "promo-003",
      name: "Xe máy cuối tuần",
      description: "Giảm 20k cho rửa xe máy T7-CN",
      discountType: "fixed",
      discountValue: 20000,
      startDate: "2026-05-01",
      endDate: "2026-06-30",
  ...
  loyaltyTransactions: [
    {
      ...
      customerId: "cust-001",
      type: "earn",
      description: "Booking BK-2026-002",
      points: 96,
      date: "2026-05-15",
    },
    {
      ...
      customerId: "cust-001",
      type: "earn",
      description: "Booking BK-2026-005",
      points: 120,
      date: "2026-05-10",
    },
    {
    ...
    },
    {
      ...
      customerId: "cust-001",
      type: "earn",
      description: "Booking BK-2026-001 (dự kiến)",
      points: 180,
      date: "2026-05-22",
    },
  ],
  ...
  rewards: [
    {
      ...
      pointsCost: 500,
      description: "Áp dụng 1 lần cho bất kỳ dịch vụ",
    },
    {
      id: "rw-002",
      name: "Rửa nhanh miễn phí (xe máy)",
      pointsCost: 800,
      description: "Miễn phí 1 lần rửa nhanh xe máy",
    },
    {
      id: "rw-003",
      name: "Nâng cấp rửa cao cấp",
      pointsCost: 1500,
      description: "Giảm 100% phí chênh lệch lên cao cấp",
    },
  ],
  ...
  rewardCatalog: [
    {
      rewardId: 1,
      rewardName: "Voucher giảm 50.000đ",
      description: "Áp dụng 1 lần cho bất kỳ dịch vụ",
      pointsRequired: 500,
    ...
    {
      rewardId: 2,
      rewardName: "Rửa nhanh miễn phí (xe máy)",
      description: "Miễn phí 1 lần rửa nhanh xe máy",
      pointsRequired: 800,
    ...
    {
      rewardId: 3,
      rewardName: "Nâng cấp rửa cao cấp",
      description: "Giảm 100% phí chênh lệch lên cao cấp",
      pointsRequired: 1500,
    ...
    {
      rewardId: 4,
      rewardName: "Voucher cũ (ngừng)",
      description: "Quà đã ngừng phát hành",
      pointsRequired: 300,
  ...
  analyticsData: {
    ...
    monthlyRevenue: [
      32000000, 35000000, 38000000, 42000000, 45000000, 48000000, 52000000,
      49000000, 51000000, 54000000, 56000000, 58000000,
    ],
...
function getTierById(tierId) {
  return (
    MOCK_DATA.loyaltyTiers.find((t) => t.id === tierId) ||
    MOCK_DATA.loyaltyTiers[0]
  );
}
  ...
  if (stored) {
    try {
      ...
      return (
        ...
        getCustomerById(MOCK_DATA.currentCustomerId)
      );
    } catch (e) {
      /* ignore */
    }
...
function normalizeTierKey(tier) {
  ...
  if (value.includes("diamond") || value.includes("platinum"))
    return "platinum";
  return value || "member";
}
...
function normalizeCustomer(customer) {
  return {
    ...
    loyaltyTier:
      customer.loyaltyTier || customer.currentTier || customer.tier || "member",
    currentPoints: Number(
      customer.currentPoints ?? customer.pointsBalance ?? customer.points ?? 0,
    ),
...
function usesRealApi() {
  return (
    ...
    window.AutoWashConfig.useMock === false
  );
}
